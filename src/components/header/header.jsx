...
const Header = () => {
    ...
    window.addEventListener("scroll", function() {
        ...
        // when the scroll is higher than the 200 viewport height, add the scroll-header class to a tag with the header class
    ...
    return (
        <header className="header">
            <nav className="nav container">
                <a href="index.html" className="nav__logo">Sunny</a>
                ...
                "nav__menu"}>
                    <ul className="nav__list grid">
                        <li className="nav__item">
                            <a href="#home" 
                            onClick={() => setActiveNav('#home')} className={activeNav === "#home" ? "nav__link active-link" : 
                            "nav__link"}>
                        ...
                        <li className="nav__item">
                            <a href="#experiences"
                                ...
                                >
                                <i className="uil uil-scenery nav__icon"></i> Experiences
                            </a>
                        </li>
